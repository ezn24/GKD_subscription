...
[![Release](https://img.shields.io/badge/release-v430-blue)](https://github.com/Lin-arm/GKD_subscription/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-902-brightgreen)](./dist/README.md#应用规则)
[![全局规则组](https://img.shields.io/badge/全局规则组-3-blueviolet)](./dist/README.md#全局规则)
[![应用规则组](https://img.shields.io/badge/应用规则组-2143-orange)](./dist/README.md#应用规则)
...
> 当前版本: v430
> 
> 当前订阅文件已适配 902 个应用，共有 2143 应用规则组，3 全局规则组
> 
...
![img](https://contrib.rocks/image?repo=Lin-arm/GKD_subscription&max=200&_v=430)
